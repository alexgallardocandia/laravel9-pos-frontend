                                            ...
                                            <tr v-for="(m, i) in carrito">
                                                ...
                                                <td>
                                                    <div class="input-group input-group-sm">
                                                        <button class="btn btn-outline-primary mb-0 btn-sm"
                                                            type="button" @click="[modalEdit = true, item = m]">
...
export default {
    ...
    methods: {
        ...
        async Datos() {
            try {
                await Promise.all([this.GET_DATA('marcas'), this.GET_DATA('categorias'), this.GET_DATA('inventario'), this.GET_DATA('sucursal')]).then((v) => {
                    this.marcas = v[0]
                    this.categorias = v[1]
                    this.articulos = v[2]
                    this.sucursals = v[3];
