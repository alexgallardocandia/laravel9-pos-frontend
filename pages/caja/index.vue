                    ...
                    <div class="card-body px-3 pt-0 pb-2">
                      <div class="table-responsive p-0">
                        ...
                        >
                          ...
                          <tbody>
                            <tr v-for="(m, i) in caja.caja_movimiento">
                              <td>
                              ...
                              <td>
                                <span v-if="m.tipo==1" class="badge badge-success" >
                                  {{m.monto}}
                                </span>
              ...
              <div class="card card-pricing">
                ...
                <div class="card-body">
                  ...
                  <a
                    ...
                    @click="Save()"
                  >
                    <i class="fas fa-save mx-2"></i> Cierre y Apertura
                  </a>
                </div>
              </div>
            </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" v-model="movimiento.motivo" class="form-control" id="">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          <label for="">Monto</label>
                          <input type="text" v-model="movimiento.monto" class="form-control" id="">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          <label for="">Movimiento</label>
                          <select type="text" v-model="movimiento.tipo" class="form-control" id="">
