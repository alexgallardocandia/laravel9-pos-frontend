            ...
            <div class="col-lg-7">
              <div class="card z-index-2">
                <div class="card-header pb-0">
                  <h6>Ventas y Compras Por Mes</h6>
                  <p class="text-sm">
       ...
       this.$nextTick(async() =>{
        ...
        try {
          ...
          new Chart(ctx2, {
            type: "line",
            data: {
              labels: self.dashboard.salesForMonths.map((m)=>m.mes),
              datasets: [
                {
                  ...
                  fill: true,
                  data: self.dashboard.salesForMonths.map((m)=>m.total),
                  maxBarThickness: 6,
                },
                {
                  ...
                  fill: true,
                  data: self.dashboard.purchasesForMonths.map((m)=>m.total),
                  maxBarThickness: 6,
                },
              ],
            },
