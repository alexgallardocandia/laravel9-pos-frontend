...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
      ...
      <hr class="horizontal dark mt-0">
          ...
          <li class="nav-item">
            ...
            <div class="collapse " id="pagesExamples">
              <ul class="nav ms-4 ps-3">
                ...
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/configuracion/medidas">
                    <span class="sidenav-mini-icon"> M </span>
                    <span class="sidenav-normal"> Medidas </span>
                  </nuxtLink>
                </li>
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/configuracion/categorias">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a data-bs-toggle="collapse" href="#pagesUsuarios" class="nav-link " aria-controls="pagesUsuarios"
              role="button" aria-expanded="false">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="collapse " id="pagesUsuarios">
              <ul class="nav ms-4 ps-3">
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/usuarios/usuario">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a data-bs-toggle="collapse" href="#pagesInventario" class="nav-link " aria-controls="pagesInventario"
              role="button" aria-expanded="false">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="collapse " id="pagesInventario">
              <ul class="nav ms-4 ps-3">
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/inventario">
      ...
      <!--CAJA-->
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a data-bs-toggle="collapse" href="#pagesCaja" class="nav-link " aria-controls="pagesCaja"
              role="button" aria-expanded="false">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="collapse " id="pagesCaja">
              <ul class="nav ms-4 ps-3">
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/caja">
                    <span class="sidenav-mini-icon"> M </span>
      ...
      <!--END CAJA-->
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a data-bs-toggle="collapse" href="#pagesCompras" class="nav-link " aria-controls="pagesCompras"
              role="button" aria-expanded="false">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="collapse " id="pagesCompras">
              <ul class="nav ms-4 ps-3">
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/compras">
                    <span class="sidenav-mini-icon"> N </span>
                    <span class="sidenav-normal"> Nueva Compra </span>
                  </nuxtLink>
                </li>
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/compras/lista">
                    <span class="sidenav-mini-icon"> C </span>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a data-bs-toggle="collapse" href="#pagesVentas" class="nav-link " aria-controls="pagesVentas"
              role="button" aria-expanded="false">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="collapse " id="pagesVentas">
              <ul class="nav ms-4 ps-3">
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/ventas">
                    <span class="sidenav-mini-icon"> N </span>
                    <span class="sidenav-normal"> Nueva Venta </span>
                  </nuxtLink>
                </li>
                <li class="nav-item ">
                  <nuxtLink class="nav-link " to="/ventas/lista">
