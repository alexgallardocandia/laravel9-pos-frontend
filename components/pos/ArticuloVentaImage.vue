    ...
    <div class="card p-0" @click="AgregarCarrito()">
        <div class="card-header mx-4 mt-2 p-1 text-center">
            <div class="icon icon-shape icon-lg bg-gradient-primary shadow text-center border-radius-lg">
                <img v-if="articulo.image" :src="articulo.image?.url" alt="image" class="border-radius-lg shadow" width="100%">
                <i v-else class="fas fa-archive opacity-10" aria-hidden="true"></i>
            </div>
        </div>
